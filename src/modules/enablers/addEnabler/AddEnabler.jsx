...
const RenderImage = () =>{
    ...
    <div className="main-container">
        ...
        <div className="container">
		   ...
		   <Button onClick={()=>fileInput.click()} style={{height:'25%',backgroundColor:'transparent',marginTop:'160px',borderColor:'transparent'}}  >
      ...
      />
			...
			/>
           <PhoneNumber /*handlePhoneChange={handlePhoneChange}*/ width='290px'/>
            <TextField
		     required
	        //  onChange={handleChange}
